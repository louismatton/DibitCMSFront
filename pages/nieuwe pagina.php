...
$json = file_get_contents("http://localhost:3000/website/".$websiteTitle);
$jsonDecoded=json_decode($json);

$orderedPages=$jsonDecoded->pages;

usort($orderedPages, function($a, $b) { 
...
<?php
$jsonContent = file_get_contents("http://localhost:3000/website/".$websiteTitle."/".$paginaTitleQuery);
